...
#PARAMETERS FOR DISPARITY MAP-FOLLOW calib.txt
doffs=124.343
b=193.001
f=3979.911
window_size2=5 
...
#RESIZING DISPARITY(NOT NEEDED IF A LARGE POINT CLOUD IS OKAY-SEE O/P WITH BETTER CLARITY IN DRIVE)
disparity = cv2.pyrDown(disp_map)
#RESIZING IMAGE FOR COLOUR(NOT NEEDED IF A LARGE POINT CLOUD IS OKAY-SEE O/P WITH BETTER CLARITY IN DRIVE)
...
#DEFINING Q FOR REPROJECTION BY FOLLOWING calib.txt
Q = np.array([[1, 0, 0, -2964/2], [0, 1, 0, -2000/2],[0, 0, 0, f],[0, 0, -1/b, doffs/b]])

#FUNCTION TO OBTAIN THE POINT CLOUD
...
#MAKING A PLY FILE FOR VISUALISATION
ply_header = '''ply
	format ascii 1.0
